function [numCells, largestInd, dataBBox, tracks, lostTracks] = functionTrialEdited()
    ...
    outputVideo_mask = VideoWriter(fullfile('C:\Users\tararelan\OneDrive\Documents\MATLAB\ELEC4900', 'output_video_frame_CVBS.avi'));
    ...
    while hasFrame(obj.reader)
        ...
        function obj = setupSystemObjects()
            ...
            obj.reader = VideoReader('video\4d 10ulhr 25mw.avi');
        ...
        function displayTrackingResults()
            ...
            if ~isempty(tracks)
                ...
                %{
                speeds = NaN(size(reliableTracks));
                for i=1:length(reliableTracks)
                   speeds(i) = reliableTracks(i).speed; 
                end
                %}
